...
At the latest file observation, 37 of 38 periodic probes complete through Windows duration 965.359 s. The latest incomplete probe is not grounds to restart the live test; retain authoritative handle 45640 until its configured three-failure stop or completion. Recovery candidate remains staged but undeployed. Goal active.
