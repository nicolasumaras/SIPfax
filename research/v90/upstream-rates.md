...
CT105 is running `aa1ac2f`, upstream initial ceiling 28800 bit/s, both supported symbol rates available, and automatic initial echo acquisition. Its verified binary SHA256 is `21f29387e6171ea977444bc1d448420b87668683197e93dd09a5ddb6b52ec7f5`. A forced-3000 sustained call recovered to 26400 and passed all 129 transfer hashes with no retries or modem errors over 581.627 seconds. A post-deployment call using normal negotiation selected 3200, recovered to 26400, and passed 18 hashes with zero errors. Downstream CP remained 49.333 kbit/s. The previous `dcb450f` binary/configuration are retained for rollback. Later historical entries are not the current deployment inventory.
