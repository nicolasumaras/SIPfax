...
void fit(const unsigned char *labels,const double *re,const double *im,
 ...
 V90Qam8Stream s={0};s.b1.position=position;
...
''')
    ...
    for trial in range(48):
        labels=[rng.randrange(96) for _ in range(128)]
        ...
        estimated=fit(labels,signal,[0,17,127][trial%3])
        ...
        estimated=fit(labels,noisy,[0,17,127][trial%3]);errors.append(estimated[2]-frequency)
