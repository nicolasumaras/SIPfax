...
''')
    ...
    subprocess.run(['gcc','-O2','-Wall','-Wextra','-Werror','-shared','-fPIC','-I'+str(root/'vendor/linmodem'),str(w),*[str(root/'vendor/linmodem'/f) for f in ['v90trellis.c','v90shell.c','v90mapping.c','v42detect.c','v90odp.c','v90equalizer.c']],'-lm','-o',str(so)],check=True)
