...
''')
    subprocess.run(['gcc','-shared','-fPIC','-O2','-Wall','-Werror','-I'+str(root/'vendor/linmodem'),str(wrapper),*[str(root/'vendor/linmodem'/n) for n in ['v90upstream.c','v90trellis.c','v90qam8.c','v90shell.c','v90phase4.c','v90pcm.c','v90cp.c','v90dil.c','v90training.c']],'-lm','-o',str(so)],check=True)
    ...
    rate={'7200':3,'9600':4,'12000':5}.get(os.environ.get('SIPFAX_V90_UPSTREAM_RATE'),2)
