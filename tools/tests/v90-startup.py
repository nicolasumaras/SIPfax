...
''')
    ...
    subprocess.run(['gcc','-shared','-fPIC','-O2','-Wall','-Werror',
                    ...
                    str(root/'vendor/linmodem/v90startup.c'),str(root/'vendor/linmodem/v90training.c'),str(root/'vendor/linmodem/v90dil.c'),str(root/'vendor/linmodem/v90cp.c'),str(root/'vendor/linmodem/v90phase4.c'),str(root/'vendor/linmodem/v90pcm.c'),str(root/'vendor/linmodem/v90upstream.c'),str(root/'vendor/linmodem/v90trellis.c'),str(root/'vendor/linmodem/v90train_tx.c'),'-lm','-o',str(libpath)],check=True)
