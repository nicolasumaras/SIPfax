...
static void mp_build(V90Phase4 *s)
{
    ...
    unsigned rate=s->upstream.rate==19200?8:s->upstream.rate==16800?7:s->upstream.rate==14400?6:s->upstream.rate==12000?5:s->upstream.rate==9600?4:s->upstream.rate==7200?3:2;
