/* Experimental upstream V.34 in V.90: 4800 four-point / 7200 eight-point / 9600 twelve-point / 12000 twenty-point / 14400 thirty-two-point.
...
void v90_upstream_init(V90Upstream *s)
{
    ...
    s->rate=rate && !strcmp(rate,"14400")?14400:rate && !strcmp(rate,"12000")?12000:rate && !strcmp(rate,"9600")?9600:rate && !strcmp(rate,"7200")?7200:4800;
